...
import {defaultClientBuilder} from "../helper";
...
const PaymentStep = () => {
  ...
  const handlePayment = () => {
    ...
    sendMetricTotalPurchase(sessionId)
  };

  const sendMetricTotalPurchase = (sessionId) => {
    const client = defaultClientBuilder(
    ...
    const payload = `{
      ...
      "userDetails": { "userId": "${sessionId}", "sessionId": "${sessionId}"}
    }`;
